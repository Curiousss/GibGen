# -*- coding: utf-8 -*-
"""
Created on Thu Jul  6 15:31:33 2017
...
VALET_SLACK_NAME = 'gibberishgenie'
VALET_SLACK_TOKEN = 'xoxb-207996525809-y7UZePVeYzUehUJaPYrKX6OB'
VALET_SLACK_ID = 'U63VAFFPT'
...
def run():
    if valet_slack_client.rtm_connect():
        print('[.] Gibberish Genie is listening...')
        while True:
